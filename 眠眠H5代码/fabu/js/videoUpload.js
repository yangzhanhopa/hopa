...
window.html5Upload = (function () {
    ...
    var videoUpload = (function () {
        ...
        videoUpload.tryUpload = function () {
            if(html5Upload.exportObject.selectFile.file){
                var video_name = encodeURIComponent(html5Upload.exportObject.selectFile.file.name);
            }else{
                uploadOption.uploadError({code: 001,msg:"请先选择视频"})
            }
            var uploadtype = 1;
    ...
    var uploadFileOperation = (function () {
        ...
        var getFileKey = function (file) {
            return [uploadFileOperation.getFileType(file), file.size, file.lastModifiedDate || file.name].join('_');
        };
        //选中文件的时候
        var inputFileChange = function (e) {
            ...
            if (file.size < 0) {
                ...
                html5Upload.exportObject.selectFile.fileKey = getFileType(file);
            }
        };
        //添加文件
